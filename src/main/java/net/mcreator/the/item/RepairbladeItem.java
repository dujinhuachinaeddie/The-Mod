...
public class RepairbladeItem extends TheElements.ModElement {
	@ObjectHolder("the:repairblade")
	public static final Item block = null;
	public RepairbladeItem(TheElements instance) {
		super(instance, 46);
	}
