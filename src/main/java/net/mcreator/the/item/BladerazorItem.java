...
public class BladerazorItem extends TheElements.ModElement {
	@ObjectHolder("the:bladerazor")
	public static final Item block = null;
	public BladerazorItem(TheElements instance) {
		super(instance, 48);
	}
