...
public class ThebladecoreItem extends TheElements.ModElement {
	@ObjectHolder("the:thebladecore")
	public static final Item block = null;
	public ThebladecoreItem(TheElements instance) {
		super(instance, 50);
	}
