...
import net.mcreator.the.item.TruekerIngotItem;
...
public class TruekerOreBlock extends TheElements.ModElement {
	@ObjectHolder("the:truekerore")
	public static final Block block = null;
	public TruekerOreBlock(TheElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TruekerIngotItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("truekerore", "truekerore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 7), Placement.COUNT_RANGE, new CountRangeConfig(4, 1, 1, 28)));
		}
	}
}
