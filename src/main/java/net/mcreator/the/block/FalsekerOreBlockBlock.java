...
public class FalsekerOreBlockBlock extends TheElements.ModElement {
	@ObjectHolder("the:falsekeroreblock")
	public static final Block block = null;
	public FalsekerOreBlockBlock(TheElements instance) {
		super(instance, 76);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("falsekeroreblock");
		}
