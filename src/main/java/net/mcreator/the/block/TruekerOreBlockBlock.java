...
public class TruekerOreBlockBlock extends TheElements.ModElement {
	@ObjectHolder("the:truekeroreblock")
	public static final Block block = null;
	public TruekerOreBlockBlock(TheElements instance) {
		super(instance, 55);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("truekeroreblock");
		}
