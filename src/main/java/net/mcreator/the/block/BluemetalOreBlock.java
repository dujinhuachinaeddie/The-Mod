...
import net.mcreator.the.item.BluemetalIngotItem;
...
public class BluemetalOreBlock extends TheElements.ModElement {
	@ObjectHolder("the:bluemetalore")
	public static final Block block = null;
	public BluemetalOreBlock(TheElements instance) {
		super(instance, 126);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BluemetalIngotItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("bluemetalore", "bluemetalore", blockAt -> {
