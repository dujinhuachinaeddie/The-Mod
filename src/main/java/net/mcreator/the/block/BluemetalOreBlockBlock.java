...
public class BluemetalOreBlockBlock extends TheElements.ModElement {
	@ObjectHolder("the:bluemetaloreblock")
	public static final Block block = null;
	public BluemetalOreBlockBlock(TheElements instance) {
		super(instance, 127);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bluemetaloreblock");
		}
