...
import net.mcreator.the.item.FalsekerGemItem;
...
public class FalsekerOreBlock extends TheElements.ModElement {
	@ObjectHolder("the:falsekerore")
	public static final Block block = null;
	public FalsekerOreBlock(TheElements instance) {
		super(instance, 75);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(FalsekerGemItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("falsekerore", "falsekerore", blockAt -> {
				boolean blockCriteria = false;
				if (blockAt.getBlock() == Blocks.STONE.getDefaultState().getBlock())
					blockCriteria = true;
				return blockCriteria;
			}), block.getDefaultState(), 7), Placement.COUNT_RANGE, new CountRangeConfig(5, 1, 1, 24)));
		}
	}
}
